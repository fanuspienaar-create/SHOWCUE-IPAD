...
## v17 — iPad Air Cue Pad Edit Fix
Built directly from the approved v16 iPad Air safe baseline. No layout redesign. Cue Pad edit buttons now use direct click + touchend handlers and explicit button type=button for older iPad Safari compatibility.
