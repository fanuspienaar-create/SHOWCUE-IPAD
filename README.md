...
## v19 — Cue Pad Edit direct iPad compatibility
Built from v16. Cue Pad pencil controls use direct inline activation so older iPad Safari does not depend on event delegation for Edit. The existing edit dialog and visual layout are unchanged.
